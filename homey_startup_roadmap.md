...
| `KaporaMiktari` | `DECIMAL(18,2)` | Alınan/istenen kapora miktarı. |
...
| `Durum` | `VARCHAR(30)` | `BOSTA`, `RANDEVULAR_MEVCUT`, `KAPORA_ASAMASINDA`, `KIRALANDI_SATILDI` |
...
graph TD
    ...
    H --> K["Kapora Aşamasında veya Kiralandı/Satıldı"]
...
*   [ ] Randevu durumu `KAPORA_ASAMASINDA` veya `KIRALANDI_SATILDI` olan portföyler için randevu alınmasını engelleyen iş mantığının yazılması.
